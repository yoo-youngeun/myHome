...
<body>
    ...
    <form action="./2_member_ok.jsp" method="post" name="regform" id="regform" onsubmit="return sendit()">
        ...
        <p>주민등록번호 : <input type="text" name="ssn1" id="ssn1" maxlength="6" onkeyup="moveFocus()" onkeydown="ssnChange()"> - <input type="text" name="ssn2" id="ssn2" maxlength="7" onkeydown="ssnChange()"> <input type="button" onclick="ssnCheck()"  value="주민등록번호 검증"></p>
        ...
        <p><input type="submit" value="가입완료"> <input type="reset" value="다시 작성"> <input type="button" value="로그인" onclick="location.href='./2_login.jsp'">
</p>
    </form>
</body>
</html>